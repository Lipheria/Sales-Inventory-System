        ...
        <>
            <form className="sign-up-form" onSubmit={register}>
                ...
                <div className="input-field">
                    ...
                    <input type="text" placeholder="Name ... Bob Jones" onChange={(e) => setName(e.target.value)} />
                </div>
                <div className="input-field">
                    <i><BiStore className="iconInput" /></i>
                    <input type="text" placeholder="Store Name: Cheese Store" onChange={(e) => setStore(e.target.value)} />
                </div>
                <div className="input-field">
                    <i><BiEnvelope className="iconInput" /></i>
                    <input type="email" placeholder="Email ... bobjones@aun.edu.ng" onChange={(e) => setEmail(e.target.value)} />
                </div>
